...
public class ShowDirection extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ShowBusOnMap showBusOnMap = new ShowBusOnMap(googleMap,this);
